...
const Navbar = () => {
  return (
    <nav className="bg-[#24292f] text-white py-4 px-6 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link href="/profile" className="hover:text-gray-300 transition-colors">
            <div className="h-8 w-8 rounded-full bg-[#21262d] flex items-center justify-center border border-[#30363d]">
               <span className="text-xs text-[#c9d1d9]">Me</span>
            </div>
          </Link>
        </div>
      </div>
